...
class ProductController extends Controller
{
    ...
    {
        $product->load('gallery', 'category', 'subcategory', 'brands', 'variants.combinations.attribute', 'variants.combinations.attributeValue');
        $categories = (new Category())->service();
    ...
    {
        $product->load('category', 'subcategory', 'brands', 'gallery', 'variants.combinations');
        $categories = (new Category())->service();
        $brands = (new Brand())->service();
        $attributes = VariantAttribute::where('status', 1)->with('values')->get();
