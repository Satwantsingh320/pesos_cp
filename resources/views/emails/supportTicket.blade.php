                  ...
                  <tr>
                    <td class="sm-px-24"
                      ...
                      <p
                        ...
                        <a href="mailto:{{ config('mail.from.address') }}" class="hover-underline"
                          style="font-family: 'Montserrat', sans-serif; mso-line-height-rule: exactly; color: #7367f0; text-decoration: none;">dejar
                          nosotros sabemos</a>.
                      </p>
                      <p
                        style="font-family: 'Montserrat', sans-serif; mso-line-height-rule: exactly; margin: 0; margin-bottom: 16px;">
                        Gracias, <br>La {{ config('app.name') }}Equipo</p>
                    </td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    <td
                      ...
                      <p style="font-family: 'Montserrat', sans-serif; mso-line-height-rule: exactly; color: #263238;">
                        El uso de nuestro servicio y sitio web está sujeto a nuestros términos y condiciones.
                        <a href="{{ config('app.url') }}" class="hover-underline"
                          style="font-family: 'Montserrat', sans-serif; mso-line-height-rule: exactly; color: #7367f0; text-decoration: none;">Términos
                          de uso</a> y
                        <a href="{{ config('app.url') }}" class="hover-underline"
                          style="font-family: 'Montserrat', sans-serif; mso-line-height-rule: exactly; color: #7367f0; text-decoration: none;">Privacidad
                          Política</a>.
                      </p>
                    </td>
                  </tr>
