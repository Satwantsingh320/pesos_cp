@php
    ...
    $breadcrumbTitlecurrent = 'Política de Privacidad';
@endphp
...
@section('content')
    <div class="container py-5">
        <div class="card shadow-sm p-5">
            ...
            <p>
                Los datos se conservarán mientras exista relación contractual y posteriormente durante los plazos exigidos
                por la legislación fiscal y mercantil española.
            </p>
            ...
            <p>
                Puede ejercer sus derechos enviando una solicitud a contacto@pesos.mx, adjuntando copia de su documento de
                identidad.
            </p>

            <h4>8. Medidas de seguridad</h4>
            <p>
                Aplicamos medidas técnicas y organizativas adecuadas para garantizar la seguridad de los datos personales y
