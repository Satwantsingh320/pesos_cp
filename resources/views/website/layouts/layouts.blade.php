          ...
          <div class="website-operation-div">
            <div class="website-list">
              ...
              <div class="user-account">
                <div class="dropdown">
                  <button class="btn btn-link p-0 border-0" data-bs-toggle="dropdown" aria-expanded="false">
              ...
              <div class="language-switcher">
                <div class="dropdown">
                  <button class="btn btn-link p-0 border-0 dropdown-toggle" data-bs-toggle="dropdown">
                    <img
                      src="{{ asset('assets/images/flags/' . (app()->getLocale() == 'en' ? 'en.png' : 'sv.png')) }}"
          ...
          <ul class="navbar-nav mx-auto mb-2 mb-lg-0">
            <li class="nav-item">
              <a class="nav-link {{ request()->routeIs('website.home') ? 'active' : '' }}" aria-current="page"
                href="{{ route('website.home') }}">{{ __('website.home') }}</a>
            </li>
            <li class="nav-item">
            ...
            <li class="nav-item dropdown">
              ...
              <ul class="dropdown-menu">
                @foreach ($menuCategories ?? [] as $category)
                  <li>
                    <a class="dropdown-item" href="{{ route('website.category.products', $category->slug) }}">
                      {{ $category->name }}
                    </a>
                  </li>
                @endforeach
          ...
          <div class="col-lg-3 col-sm-6">
            <div class="link-footer">
              ...
              <ul>
                ...
                <li><a href="{{ route('returnPolicy') }}">{{ __('website.return_policy') }}</a></li>
              </ul>
            </div>
          </div>
          <div class="col-lg-3 col-sm-6">
