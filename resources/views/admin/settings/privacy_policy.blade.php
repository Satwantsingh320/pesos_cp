            ...
            <div class="row">
                <div class="col-6">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0 font-size-18">{{__('admin.privacy_policy')}}</h4>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-xl-12">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="card-title mb-4">{{__('admin.edit_privacy_policy_page')}}</h4>
                            <form method="POST" action="{{ route('setting.page.update') }}">
                                @csrf
                                <input type="hidden" name="page_name" value="privacy_policy">
                                <div class="mb-3">
