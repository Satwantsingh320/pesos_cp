        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-xl-9">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="card-title mb-4">{{__('admin.add_subcategory')}} </h4>
                            <form method="POST" action="{{ route('subcategory.store') }}">
                                ...
                                <div class="row mb-4">
                                    <label for="horizontal-email-input" class="col-sm-3 col-form-label">{{__('admin.subcategory_name')}}</label>
                                    <div class="col-sm-9">
                                        <input type="text" name="name" placeholder="{{__('admin.enter_subcategory_name')}}" class="form-control" required value="{{ old('name') }}">
                                    </div>
                                </div>
                                <div class="row mb-4">
