                ...
                <div class="row">
                    <div class="col-12">
                        <div class="page-title-box d-sm-flex align-items-center">
                            <a href="{{ route('customers.index') }}" class="btn btn-dark btn-sm mx-2"><i
                                ...
                                <form method="POST" action="{{ route('customers.store') }}" enctype="multipart/form-data">
                                    ...
                                    <div class="row mb-4">
                                        <label for="horizontal-email-input"
                                            class="col-sm-3 col-form-label">{{__('admin.name')}}</label>
                                        <div class="col-sm-9">
                                            <input type="text" name="name" placeholder="{{__('admin.enter_customer_name')}}"
                                                class="form-control" required value="{{ old('name') }}">
                                        </div>
                                    </div>
                                    <div class="row mb-4">
                                        <label for="horizontal-email-input"
                                            class="col-sm-3 col-form-label">{{__('admin.email')}}</label>
                                        <div class="col-sm-9">
                                            <input type="text" name="email"
                                                placeholder="{{__('admin.enter_customer_email')}}" class="form-control"
                                                required value="{{ old('email') }}" autocomplete="off">
                                        </div>
                                    </div>
                                    <div class="row mb-4">
                                        <label for="horizontal-email-input"
                                            class="col-sm-3 col-form-label">{{__('admin.phone')}}</label>
                                        <div class="col-sm-9">
                                            <input type="text" name="phone" id="phone"
                                                placeholder="{{__('admin.enter_customer_phone_number')}}"
                                                class="form-control" required value="{{ old('phone') }}">
                                            <input type="hidden" name="dial_code" id="dial_code" value="+46" />
                                            <input type="hidden" id="dial_code_iso" name="dial_code_iso" value="MX">
                                        </div>
                                    </div>
                                    <div class="row mb-4">
                                        <label for="horizontal-email-input"
                                            class="col-sm-3 col-form-label">{{__('admin.password')}}</label>
                                        <div class="col-sm-9">
                                            <input type="password" name="password"
                                                placeholder="{{__('admin.enter_customer_password')}}" class="form-control"
                                                required value="{{ old('password') }}" autocomplete="off">
                                        </div>
                                    </div>
                                    <div class="row mb-4">
                                        <label for="horizontal-email-input"
                                            class="col-sm-3 col-form-label">{{__('admin.status')}}</label>
                                        <div class="col-sm-9">
                                    ...
                                    <div class="row mb-4">
                                        <label for="horizontal-email-input"
                                            class="col-sm-3 col-form-label">{{__('admin.profile_pic')}}</label>
                                        <div class="col-sm-9">
                                            <input type="file" name="image" class="form-control" accept="image/*"
                                                onchange="previewCoverImage(this)" required>
                                            <div class="mt-2">
