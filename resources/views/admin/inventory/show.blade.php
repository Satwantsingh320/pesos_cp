                                ...
                                <form method="POST" action="{{ route('offers.update', $offer->id) }}"
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                <label for="horizontal-email-input"
                                                    class="col-sm-6 col-form-label">{{__('admin.select_category')}}</label>
                                                <select name="category" class="form-control select2 __category"
                                                    data-route="{{route('subcategory.service')}}" required>
                                                    @foreach($categories as $key => $value)
                                                        <option value="{{ $key }}" @if($offer->category_id == $key) selected
                                                        @endif>
                                                            {{ $value }}
                                                        </option>
                                                    @endforeach
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                <label for="horizontal-email-input"
                                                    class="col-sm-6 col-form-label">{{__('admin.select_subcategory')}}</label>
                                                <select name="subcategory" class="form-control select2 __subcategory"
                                                    data-route="{{route('products.service')}}"
                                                    data-selected="{{ $offer->subcategory_id }}" required>
                                                </select>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                <label for="horizontal-email-input"
                                                    class="col-sm-6 col-form-label">{{__('admin.select_product')}}</label>
                                                <select name="product" class="form-control select2 __product"
                                                    data-route="{{ route('products.service') }}"
                                                    data-price-route="{{ route('products.get-price') }}"
                                                    data-selected="{{ $offer->product_id }}" required>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                <label for="horizontal-email-input"
                                                    class="col-sm-6 col-form-label">{{__('admin.price')}}</label>
                                                <div class="input-group">
                                                    <span class="input-group-text">{{env('CURRENCY_SYMBOL')}}</span>
                                                    <input type="text" name="price"
                                                        placeholder="{{__('admin.enter_price')}}"
                                                        class="form-control __numeric_decimal __price" required
                                                        value="{{ $offer->price }}" readonly>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                <label for="horizontal-email-input"
                                                    class="col-sm-6 col-form-label">{{__('admin.offer_price')}}</label>
                                                <div class="input-group">
                                                    <span class="input-group-text">{{env('CURRENCY_SYMBOL')}}</span>
