                    ...
                    <div class="card">
                        <div class="card-body">
                            <form method="POST" action="{{ route('inventory.store') }}" id="inventoryForm">
                                ...
                                <div class="mb-3">
                                    <label class="form-label">{{ __('admin.inventoryArray.select_product_type') }}</label>

                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="item_type" id="simple_product" value="simple" checked>
                                    ...
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="item_type" id="variant_product" value="variant">
                                ...
                                <div id="simple_product_section">
                                    <div class="mb-3">
                                        <label class="form-label">{{ __('admin.inventoryArray.select_product') }}</label>
                                        <select name="simple_product_id" id="simple_product_id" class="form-select">
                                            <option value="">{{ __('admin.inventoryArray.select_product_placeholder') }}</option>
                                            @foreach($simpleProducts as $product)
                                                <option value="{{ $product->id }}" data-sku="{{ $product->sku_number }}" data-stock="{{ $product->quantity }}">
                                                    {{ $product->name }} (SKU: {{ $product->sku_number }}) - Stock: {{ $product->quantity }}
                                                </option>
                                            @endforeach
                                        </select>
                                    </div>
                                ...
                                <div id="variant_product_section" style="display: none;">
                                    ...
                                    <div class="mb-3">
                                        <label class="form-label">{{ __('admin.inventoryArray.select_variant') }}</label>
                                        <select name="variant_id" id="variant_id" class="form-select" disabled>
                                            <option value="">{{ __('admin.inventoryArray.select_product_first') }}</option>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" id="current_stock_display" class="form-control" readonly disabled>
                                </div>

                                <div class="mb-3">
                                    <label class="form-label">{{ __('admin.inventoryArray.notes_optional') }}</label>
                                    <textarea name="notes" class="form-control" rows="3" placeholder="{{ __('admin.inventoryArray.notes_placeholder') }}"></textarea>
                                </div>
                                ...
                                <table class="table table-sm">
                                    ...
                                    <tbody>
                                        ...
                                        @foreach($recentInventory as $item)
                                            <tr>
                                                <td>{{ $item->created_at->format('d M H:i') }}</div>
                                                <td>
