...
<div class="main-content">
    <div class="page-content">
        <div class="container-fluid">
                ...
                <div class="col-8">
                    <div class="d-flex justify-content-end flex-wrap gap-2">
                        <a href="{{ route('category.create') }}" class="btn btn-primary btn-sm">
                            <i class="bx bx-plus"></i> {{ __('admin.add_category') }}
                        </a>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <form class="row my-2" action="{{ route('category.index') }}" method="get" id="form-search">
                        @csrf
                        <h5 class="card-title">{{__('admin.filter_categories')}}</h5>
                        <div class="row">
                            <div class="col-sm-4">
                            ...
                            <div class="col-sm-3">
                                ...
                                <a href="{{ route('category.index') }}" class="btn btn-danger">{{__('admin.reset')}}</a>
                            </div>
                        </div>
                    </form>
                </div>
